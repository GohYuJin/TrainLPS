...
def resnet18_fs(pretrained: WeightsEnum = None, progress: bool = True, **kwargs: Any) -> ResNet:
    return _resnet(BasicBlockCustom, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet101_fs(pretrained: WeightsEnum = None, progress: bool = True, **kwargs: Any) -> ResNet:
    return _resnet(BottleneckLiteCustom, [3, 4, 23, 3], pretrained, progress, **kwargs)
...
class ResNetLite50Type1Custom(AbstractBaseClassifierModel):
  def __init__(self,input_shape,num_classes,
               padding_mode='zeros',learning_rate=0.1,pooling_layer=nn.AvgPool2d,
               extras_model=None,**kwargs):
    super().__init__(**kwargs)
