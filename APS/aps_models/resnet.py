...
from APS.aps_models.apspool import ApsPool
...
def resnet50(pretrained=False, filter_size=4, pool_only=False, apspool_criterion = 'l2', N_in = None, **kwargs):
    ...
    Args:
        ...
        pool_only (bool): [True] don't antialias the first downsampling operation (which is costly to antialias)
    """
    print('Loading Resnet50-aps model')
    
    model = ResNet(Bottleneck, [3, 4, 6, 3], filter_size=filter_size, pool_only=pool_only, apspool_criterion = apspool_criterion, N_in = N_in, **kwargs)
